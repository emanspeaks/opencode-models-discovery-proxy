...
export class ToastNotifier {
  ...
  async success(message: string, title?: string, duration?: number): Promise<void> {
    try {
      ...
      console.error(`[opencode-models-discovery-proxy] Failed to show success toast`, error)
    }
  }
  ...
  async info(message: string, title?: string, duration?: number): Promise<void> {
    try {
      ...
      console.error(`[opencode-models-discovery-proxy] Failed to show info toast`, error)
    }
  }
  ...
  async progress(message: string, title?: string, progress?: number): Promise<void> {
    try {
      ...
      console.error(`[opencode-models-discovery-proxy] Failed to show progress toast`, error)
    }
  }
  ...
  async detailed(options: {
    ...
    try {
      ...
      console.error(`[opencode-models-discovery-proxy] Failed to show detailed toast`, error)
    }
  }
}
